...
```bash
python -m llama_recipes.finetuning --use_peft --peft_method lora --quantization --model_name /home/xuhang/hf_hub/Meta-Llama-3-8B-hf --output_dir /home/xuhang/llama/models/Meta-Llama-3-8B/PEFT/model --use_wandb
```
